from pyuspsaddress2 import USPSAPI
...
def test_get_official_addres(usps_api):
    usps_resp = usps_api.get_offical_address_resp_usps(
                '61 URB VALLE BORIKEN',
                '',
                'GURABO',
                'PR',
                '00778'
            )
    assert usps_resp.status_code == HTTP_200_OK
